...
- (void)viewDidLoad
{
    ...
    NSString *path = nil;
    path = [self getPath:@"appStringPath"];
    if( path != nil )
    {
...
- (void)replaceLString:(LStringObject *)object
{
    ...
    PyObject_CallMethod(_stringCheck,"replaceLocalString", "(sssssss)",
                        [object.line UTF8String],
                        [object.lang UTF8String],
                        [object.name UTF8String],
                        [object.key UTF8String],
                        [value UTF8String],
...
- (void)writeLString:(LStringObject *)object
{
    ...
    PyObject_CallMethod(_stringCheck,"writeLocalString", "(sssssss)",
                        [object.line UTF8String],
                        [object.lang UTF8String],
                        [object.name UTF8String],
                        [object.key UTF8String],
